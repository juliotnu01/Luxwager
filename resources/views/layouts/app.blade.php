...
/* Mobile Only */
    ...
    <body class="homepage">
        <div id="page-wrapper">
            ...
            <div class="wrapper style1" id="intro-wrapper">
                ...
                <section class="container" id="intro">
                    ...
                    <p class="style2">
                        ...
                        site template by
                        <a class="nobr" href="http://html5up.net">
                            HTML5 UP
                        </a>
                    </p>
                    <p class="style3">
                ...
                <div class="container" id="main">
                    ...
                    <section id="features">
                        <header class="style1">
                            ...
                            <p>
                                Feugiat dolor nullam orci pretium phasellus justo
                            </p>
                        </header>
                        ...
                        <ul class="actions actions-centered">
                            <li>
                                <a class="button style1 big" href="#">
                                    Get Started
                                </a>
                            </li>
                            <li>
                                <a class="button style2 big" href="#">
                                    More Info
                                </a>
                            </li>
                        </ul>
            ...
            <div class="wrapper" id="footer-wrapper">
                ...
                <div class="container" id="footer">
                    <header class="style1">
                        <h2>
                            Ipsum sapien elementum portitor?
                        </h2>
                        <p>
                            ...
                            <section>
                                <form action="#" method="post">
                                    <div class="row 50%">
                                        ...
                                        <div class="6u 12u(mobile)">
                                            <input id="contact-email" name="email" placeholder="Email" type="text"/>
                                        </div>
                                    </div>
                                    <div class="row 50%">
                                        <div class="12u">
                                    ...
                                    <div class="row">
                                        <div class="12u">
                                            <ul class="actions">
                                                <li>
                                                    <input class="style1" type="submit" value="Send"/>
                                                </li>
                                                <li>
                                                    <input class="style2" type="reset" value="Reset"/>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <script src="assets/js/skel-viewport.min.js">
        </script>
